...
<head>
    ...
    <title>Alerts - Tap-and-Go Doorlock</title>
...
<body>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">
                        <i class="fas fa-bell me-2" style="color: #1a3a6a;"></i>
                        Alerts
                ...
                <!-- ============================================================
                WARNING NOTIFICATION BAR - SAME AS DASHBOARD
                ============================================================ -->
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-7">
                                        <div class="d-flex align-items-start">
                                            <?php if ($isCritical): ?>
                                                <span class="pulse-red me-2" style="font-size: 24px;">🚨</span>
                ...
                <footer class="pt-4 pb-2 text-muted text-center small border-top mt-3">
                    ...
                    <span class="mx-2">|</span>
                    <span>Total: <?php echo $stats['total']; ?> alerts</span>
                    <?php if ($stats['pending'] > 0): ?>
    ...
    <script>
        ...
        // ============================================================
        // UPDATE LAST UPDATE TIME - SAME AS DASHBOARD
        // ============================================================
